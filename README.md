...
Hera 是一个用小程序写法来写跨平台应用的开发框架，使用它可以让你的小程序除了在微信上运行，还可以打包成 Android 、 iOS应用，以及以h5的方式跑在浏览器端
...
运行于客户端上请参考：[快速上手](https://Weidian-developer.github.io/hera/#/basics/quickstart)
